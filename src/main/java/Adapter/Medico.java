...
public class Medico extends Usuario {
    ...
    public String getDisponibilidad(String fecha) {
        String disponibilidad = "\nHoras en las que el medico " + this.getLogin() + " se encuentra disponible el dia " + fecha + "\n";
        boolean cupo = false;
        ...
        if (this.horario.containsKey(fecha)) {
            ...
            return "No hay agenda programada para ese dia";
        }
    ...
    public String getCitas(String fecha) {
        String disponibilidad = "Citas del medico " + this.getLogin() + " para el dia " + fecha + "\n";
        ...
        return (agenda) ? disponibilidad : "No hay citas para ese dia";
    }
