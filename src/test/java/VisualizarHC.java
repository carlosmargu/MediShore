...
public class VisualizarHC {
    ...
    Facede facade = new Facede();
            ...
            String com="20/11/2019, Juan, 34567, India, Estudiante, Migraña severa, Familiares, Enrojecimiento en la parte posterior de la cabeza, Medicamentos y descanso";
            assertEquals(com,facade.verHistoriaPaciente("34567"));
    }
}
*/